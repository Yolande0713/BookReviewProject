...
export default [
  ...
  },
  {
    ...
    rating: "8/10",
    summary:
      "This book focuses of a white knight and the black sorcerer of Grimslock. The Princess decision leading to mass murder, the knight had two choices enlist the help of the sorcerer or face the attackers alone and risk his life in doing so. He choose to enlist the help of the Black sorcerer. What did the Black sorcerer do when he see the white knight? He decided to keep him.",
    review:
  ...
  },
  {
    ...
    review:
      "A lot of the Sherwood books I have read so far are very lighthearted and downright ridiculously fun read. This book was one of the sweet, quirky and lovely. Few books I have read cause a lot of anxiety very intense. The mystery in this book was not as intense in fact it was very relaxing to me. This is a great book to read after reading heavy a book or if you are like me who read just for the fun of it. This book is it. Jon job is dangerous as a psychic he works as a lie detector for the police department in the area. Donovan as Jon's bodyguard have had hard time making connection with people due to his intimidating size. However Jon' was able to see Donovan's kindness, generosity and incredible patience. These two working together, learning about each other and always on the go. The case there were working on very complicated, shooting that did not make sense, victim who is not what it seem. The result of this case was very unconventional. I loved the case. I def recommend this book.",
  },
  {
    title: "Dune",
    image: dune,
